...
The sample code for this section is extracted from [ArithmeticSequenceImplementationTests](ArithmeticSequence.playground/Sources/ArithmeticSequenceImplementationTests) file found in the project folder.
